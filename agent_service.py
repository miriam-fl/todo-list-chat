...
API_BASE_URL = os.getenv('API_BASE_URL', 'https://chat-api.malkabruk.co.il/openai')
...
async def agent(query):
    ...
    if not OPENAI_API_TOKEN:
        raise ValueError("OPENAI_API_TOKEN environment variable is required")
    ...
    try:
        ...
        if len(response.text) > 500 and DEBUG_MODE:
